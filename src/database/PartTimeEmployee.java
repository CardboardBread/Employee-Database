...
public class PartTimeEmployee extends Employee {
	...
	public PartTimeEmployee(int num, String first, String last, String s, String work, float money, float ded,
			float HPW, float HPY, int time) {
	...
	public void setWorkTerm(int value) {
		workTerm = value;
	}

	public void setHoursPerWeek(float value) {
		hoursPerWeek = value;
	}

	public void setHoursPerYear(float value) {
		hoursPerYear = value;
	}
